        ...
        if ($id !== null && $id !== 254) {
            ...
            switch ($id) {
                ...
                case 410:
                    ...
                    break;
                case 411:
                    $classEnum = Classes::tryFrom($base >> 1);
                    $desc .= 'Limit Class: ' . ($classEnum?->shortName() ?? 'Unknown');
                    break;
                case 412:
                ...
                case 485:
                    $classEnum = Classes::tryFrom($base >> 1);
                    $desc .= 'Limit Caster Class: ' . ($classEnum?->shortName() ?? 'Unknown') . ' (Outgoing Focus Limit)';
                    break;
                case 486:
