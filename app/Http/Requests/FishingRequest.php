...
class FishingRequest extends BaseRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'skill_level' => 'integer|min:0|max:32767|nullable',
            'chance' => 'integer|min:0|max:32767|nullable',
            'npc_id' => 'integer|min:0|max:2147483647|nullable',
            'npc_chance' => 'integer|min:0|max:2147483647|nullable',
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'skill_level' => $this->defaultInt('skill_level', 0),
            'chance' => $this->defaultInt('chance', 0),
            'npc_id' => $this->defaultInt('npc_id', 0),
            'npc_chance' => $this->defaultInt('npc_chance', 0),
