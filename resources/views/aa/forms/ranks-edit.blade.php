        ...
        <div class="card-body">
            <div class="grid grid-cols-7 gap-4">
                ...
                <x-form.input
                    ...
                    :value="$rank['next_id']"
                />
                <div x-data="dbstrLookup(1, 'title_sid')" class="flex flex-col">
                ...
                <div x-data="dbstrLookup(4, 'desc_sid')" class="flex flex-col">
                ...
                <div x-data="dbstrLookup(2, 'lower_hotkey_sid')" class="flex flex-col">
                ...
                <div x-data="dbstrLookup(3, 'upper_hotkey_sid')" class="flex flex-col">
