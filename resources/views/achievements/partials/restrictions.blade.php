<div class="card bg-base-100 shadow">
    <div class="card-body">
        <div class="flex flex-wrap items-start justify-between gap-4">
            <div>
                <h2 class="card-title">Cast Restrictions</h2>
                <p class="text-sm opacity-65">
                    Attach spell cast-restriction IDs to this achievement. Reusing one restriction ID across achievements
        ...
        <div x-show="editor.restrictions.length === 0" class="rounded-box border border-dashed border-base-content/20 p-4 mt-3 text-center text-sm opacity-65">
            No spell cast restrictions reference this achievement.
        </div>
    </div>
</div>
